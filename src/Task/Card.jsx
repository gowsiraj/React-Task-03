...
function Card({ title, detail,onDelete,status,taskList,setTaskList,onEdit}) {
  ...
  return  ( 
    <div className="col-lg-4 col-md-4 col-sm-6 col-xl-4  mt-3">
  ...
  {isEditing ? (
    ...
    {/* <p class="card-text"><strong>Task Name:</strong> {title}</p>
    <p class="card-text"><strong>Description:</strong> {detail}</p> */}
